                    ...
                    <div className="flex overflow-x-auto gap-2 pt-3 pb-2 scrollbar-hide">
                        {CATEGORIES.map(category => (
                            <button
                                ...
                                className={`whitespace-nowrap px-3 py-2 rounded-full text-xs font-medium transition-colors border ${activeCategory === category
                    ...
                    {Object.entries(grouped).length === 0 ? (
                        ...
                        Object.entries(grouped).map(([category, exList]) => (
                            <div key={category} className="mb-4">
                                {activeCategory === "All" && (
                                    <h3 className="text-[11px] uppercase tracking-widest font-bold text-slate-400 mb-2 px-1">
                                        {category}
                                    </h3>
                                )}
